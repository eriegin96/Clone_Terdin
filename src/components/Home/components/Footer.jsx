		...
		<div className="max-w-9/10 m-auto p-5">
			...
			<div>
				<p className="mb-3 text-text-secondary text-xs">
					...
					it casual, you need to be on Terdin. With over 55 billion matches made, it’s the place to
					be to meet your next best match. Let’s be real, the dating landscape looks very different
					today, as most people are meeting online. With Terdin, the world’s most popular free
					...
					Terdin’s here to bring you all the sparks.
				</p>
				<p className="mb-3 text-text-secondary text-xs">
					There really is something for everyone on Terdin. Want to get into a relationship? You got
					it. Trying to find some new friends? Say no more. New kid on campus and looking to make
					the most of your college experience? Terdin U’s got you covered. Terdin isn’t your average
